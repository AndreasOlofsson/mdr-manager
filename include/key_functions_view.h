...
#ifndef __KEY_FUNCTIONS_VIEW_H__
#define __KEY_FUNCTIONS_VIEW_H__

#include <gtk/gtk.h>

#define MDR_KEY_FUNCTIONS_VIEW_TYPE (mdr_key_functions_view_get_type())
G_DECLARE_FINAL_TYPE(MDRKeyFunctionsView,
                     mdr_key_functions_view,
                     MDR, KEY_FUNCTIONS_VIEW,
                     GtkBox)

#endif /* __KEY_FUNCTIONS_VIEW_H__ */
